package com.ohgiraffers.chap04.section01.level04advanced;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        System.out.println("월 급여를 입력하십시오. : ");
        int salary = sc.nextInt();

        System.out.println("총 매출액을 입력하십시오. : ");
        ...
        System.out.println("보너스 금액 : " +( totalSales * bonus ));
        System.out.println("==================");
        System.out.println("총 급여 : " + ( salary + (totalSales * bonus )));
